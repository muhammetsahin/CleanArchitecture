...
namespace CleanArchitecture.CrossCutting;
...
public static class Extensions
{
    ...
    {
        return DependencyContext.Default.GetDefaultAssemblyNames().Where(assembly => assembly.FullName.StartsWith(nameof(CleanArchitecture))).Select(Assembly.Load);
    }
